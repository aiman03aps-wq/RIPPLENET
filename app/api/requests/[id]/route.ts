...
async function findRequest(idOrCode: string) {
  ...
  const mockDb: Record<string, any> = {
    "RIP-2026-00001": {
      ...
      status: "in_transit",
      createdAt: new Date(),
      camp: { id: 1, name: "Badin Relief Camp", district: "Badin", phone: "0297 123456", lat: 24.6561, lng: 68.8368 },
    ...
    "RIP-2026-00002": {
      ...
      status: "assigned",
      createdAt: new Date(),
      camp: { id: 1, name: "Nowshera Relief Camp", district: "Nowshera", phone: "0923 123456", lat: 34.0153, lng: 71.9747 },
